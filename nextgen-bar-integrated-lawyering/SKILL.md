---
name: nextgen-bar-integrated-lawyering
description: "Organize supervised legal-task reasoning from supplied fictional or public materials: jurisdiction, authority, facts, issues, options, uncertainty, and review. Never provide live legal advice."
---
...
Use this skill to operationalize competency F2-COMP-66-NEXTGEN-BAR-001 as a bounded,
...
Use it for supervised legal-task organizer when the user supplies a domain task, case, passage,
study, policy record, model, or design record. Do not use it as a
lawyer, legal adviser, filing agent, or substitute for jurisdiction-specific review.
...
- matter, role, jurisdiction, and confidentiality orientation
- authority and fact control
- issue spotting and rule-fact application
- options, counseling, and negotiation
- professional writing and escalation

## Evidence requirements

- authority log with source and jurisdiction
- fact and issue ledger
- rule-fact analysis with counterarguments
- options and uncertainty record
...
- Use fictional or public educational matters only; never provide live legal advice or practice authorization.
...
Qualified legal review owns legal accuracy, confidentiality, professional responsibility, and consequential use.
